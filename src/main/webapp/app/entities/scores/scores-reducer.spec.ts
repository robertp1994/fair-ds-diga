...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scores.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCORES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCORES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCORES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCORES actions', async () => {
      const arg = 42666;
