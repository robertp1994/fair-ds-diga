...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINGERTAPS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINGERTAPS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINGERTAPS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FINGERTAPS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FINGERTAPS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINGERTAPS actions', async () => {
      const arg = 42666;
